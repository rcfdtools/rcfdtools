...
| [:notebook: License](LICENSE.md) || [:notebook: References](file/ref/Readme.md) | [:label: Dictionary](file/ref/Dictionary.md) | [:construction_worker: Professional expertise level (PEL)](R.PEL.md) |
|---------------------------------------------|----------------------------------------------|----------------------------------------------------------------------|
