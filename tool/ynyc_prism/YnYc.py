...
results += f'\n{funcs.txt_separator(70)}\n{shape} SHAPE >>> Input values ({dict.dictionary['unit_sys']}: {unit_sys})\n{funcs.txt_separator(70)}\n\n'
results += f'General parameters\n\n'
results += f'{dict.dictionary['Q']}: {q} {unit_q}\n'
results += f'{dict.dictionary['g']}: {g} {unit_g}\n'
results += f'{dict.dictionary['b']}: {b} {unit_length}\n'
results += f'{dict.dictionary['z1']}: {z1} {unit_length}\n'
results += f'{dict.dictionary['z2']}: {z2} {unit_length}\n'
results += f'{dict.dictionary['So']}: {so} {unit_length}/{unit_length}\n'
results += f'{dict.dictionary['n']}: {n}\n'
results += f'{dict.dictionary['alpha']}: {alpha}\n'
results += f'{dict.dictionary['rho']}: {rho} {unit_rho}\n'
results += f'{dict.dictionary['c']}: {c}\n\n'
results += f'Numerical method parameters\n\n'
results += f'{dict.dictionary['y1']}: {y1aux} {unit_length}\n'
results += f'{dict.dictionary['y2']}: {y2aux} {unit_length}\n'
results += f'{dict.dictionary['steps']}: {steps}\n'
