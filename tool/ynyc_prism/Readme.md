...
| YnYcE0003 - Trapezoidal channel in subcritical regime.                        | Parameters: unit_sys = 'SI', q = 10, g = 9.806, b = 5, z1 = 2, z2 = 2, so = 0.0008969, n = 0.035, alpha = 1, rho = 1000, y1 = 0.0001, y2 = 5, steps = 128.   | <img alt="R.HydroTools" src="assets/exercise/YnYcE0003.svg" width="600px"> |
